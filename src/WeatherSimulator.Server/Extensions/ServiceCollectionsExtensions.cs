...
public static class ServiceCollectionsExtensions
{
    public static IServiceCollection AddSensorsHostedServices(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddSingleton<IMeasureSourceService, MeasureSourceService>();
        services.AddSingleton<ISensorMeasureMapper, SensorMeasureMapper>();
        services.AddSingleton<ISensorLocationTypeMapper, SensorLocationTypeMapper>();
        return services;
    }
}
